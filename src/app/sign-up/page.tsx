...
export default function Sign() {
    return (
      <div className="flex justify-center mt-28 sm:mb-20 mb-28">
        ...
        <button className="ml-8 mr-2 box-border h-8 w-20  rounded-full bg-accent border mt-4 text-white">Login</button>or
        <button className="ml-2 box-border h-8 w-36 border-2 rounded-full bg-accent text-white">Create Account</button>
        </form>
