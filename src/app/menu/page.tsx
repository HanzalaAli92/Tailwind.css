...
const menuData = [
    {
        ...
        desc: "2x tuna sashimi, 1x noodles",
        price: "$29.50",
    },
    {
...
const Menu = () => {
  return (
    <div className='container pt-40'>
     ...
     <div className='grid lg:grid-cols-[35%,1fr] gap-10 pt-10 ml-0 sm:ml-10'>
         <div className='w-fit mx-auto'>
            <Image 
         ...
         <div className='grid w-fit max-auto sm:grid-cols-2 gap-4 ml-0 sm:ml-16 '>
